...
#img_list = req.quote(soup.select_one("figure.is_thumbnail > img")['src'][25:])
print("Test", recommand)

#print(soup.select_one("figure.is_thumbnail > img")['src'])
